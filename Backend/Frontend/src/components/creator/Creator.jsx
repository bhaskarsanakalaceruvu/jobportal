      ...
      <div className="flex flex-col items-center justify-center h-screen max-w-7xl mx-auto p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center w-full">
          ...
          <div className="flex justify-center">
            <img src={bhaskar} alt="Amresh Sir" className="h-80 object-cover rounded-lg shadow-md" />
          </div>
          {/* Text Section */}
          <div>
      ...
      <div className="text-center p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <a href="https://ankitpathak.vercel.app/" target="_blank" rel="noopener noreferrer" className="block text-center">
            <img src={bhaskar} alt="Ankit Pathak" className="mx-auto rounded-lg shadow-md" />
          ...
          <a href="#" className="block text-center">
            <img src={raghu} alt="Ritik Shrivastava" className="mx-auto rounded-lg shadow-md" />
          ...
          <a href="#" className="block text-center">
            <img src={bhaskar} alt="Gaurav Kumar" className="mx-auto rounded-lg shadow-md" />
